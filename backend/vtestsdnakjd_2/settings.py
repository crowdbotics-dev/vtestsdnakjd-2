"""
Django settings for vtestsdnakjd_2 project.
...
ROOT_URLCONF = 'vtestsdnakjd_2.urls'
...
WSGI_APPLICATION = 'vtestsdnakjd_2.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "vtestsdnakjd Support <support@vtestsdnakjd-2.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "vtestsdnakjd_2 API",
    "DESCRIPTION": "API documentation for vtestsdnakjd_2 App",
    "VERSION": "v1",
}
...
if AS_BUCKET_NAME:
    ...
    DEFAULT_FILE_STORAGE = "vtestsdnakjd_2.storage_backends.AzureMediaStorage"
    STATICFILES_STORAGE = "vtestsdnakjd_2.storage_backends.AzureStaticStorage"
